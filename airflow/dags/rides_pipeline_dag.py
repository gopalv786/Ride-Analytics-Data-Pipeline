...
# GCP Configuration
PROJECT_ID = Variable.get('GCP_PROJECT_ID', default_var='project-a65e021b-fab6-45bf-9a2')
REGION = Variable.get('GCP_REGION', default_var='asia-east1')
CLUSTER_NAME = Variable.get('DATAPROC_CLUSTER_NAME', default_var='hadoop-dev')
BUCKET_NAME = Variable.get('GCS_BUCKET_NAME', default_var='ride-analytics-storage')  # Single bucket for all data
